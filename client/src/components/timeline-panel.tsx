            ...
            <div key={location.id} className="relative">
              ...
              <div
                className={cn(
                  ...
                  isPointA
                    ? "border-green-500 scale-125 shadow-[0_0_0_4px_rgba(34,197,94,0.2)]"
                    : isPointB
                    ? "border-blue-500 scale-125 shadow-[0_0_0_4px_rgba(59,130,246,0.2)]"
                    : isSelected
                    ? "border-primary scale-125 shadow-[0_0_0_4px_rgba(var(--primary),0.2)]"
              ...
              <motion.div
                ...
                className={cn(
                  ...
                  isPointA
                    ? "bg-green-50/50 border-green-500/30 shadow-xl ring-1 ring-green-500/20 scale-[1.02]"
                    : isPointB
                    ? "bg-blue-50/50 border-blue-500/30 shadow-xl ring-1 ring-blue-500/20 scale-[1.02]"
                    : isSelected
              ...
              >
                ...
                <div className="h-40 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-3 left-3 flex gap-2">
                    <Badge variant={location.category}>
                      {location.category}
                    </Badge>
                    {location.difficulty && (
...
function Badge({
  ...
  return (
    <span
      className={cn(
        "text-[10px] uppercase tracking-wider font-bold px-2 py-0.5 rounded-full shadow-xs",
        selectedStyle
      )}
    >
      {children}

...
class RouteAnimationController {
   ...
   */ initialize(routeCoordinates, checkpoints) {
   ...
   */ findCheckpointIndices() {
        ...
        for (const checkpoint of this.checkpoints){
            ...
            for(let i = 0; i < this.routeCoordinates.length; i++){
                ...
                const distance = Math.sqrt(Math.pow(lng - checkpoint.lng, 2) + Math.pow(lat - checkpoint.lat, 2));
   ...
   */ createTimeline() {
        ...
        this.timeline = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].timeline({
            paused: true,
            onStart: ()=>{
        ...
        const segmentDuration = this.config.durationPerSegment ? this.config.durationPerSegment / 1000 : this.config.duration / 1000 / Math.max(1, this.routeSegments.length);
        ...
        for(let i = 0; i < this.routeSegments.length; i++){
            ...
            }, undefined, segmentLabel);
            // Animação do progresso do segmento (0 a 1)
            this.timeline.to(this.segmentProgressRef, {
                value: 1,
        ...
        this.timeline.to(this.progressRef, {
            value: 1,
            duration: 0,
            ease: "none"
        }, 0);
   ...
   */ updateProgress() {
        ...
        const cursorPos = this.getPointAlongSegment(this.currentSegmentIndex, segmentProgress);
        ...
        const partialRoute = this.getPartialRouteFromSegments(this.currentSegmentIndex, segmentProgress);
   ...
   */ getPointAlongSegment(segmentIndex, segmentProgress) {
        if (segmentIndex < 0 || segmentIndex >= this.routeSegments.length || this.routeSegments[segmentIndex].length === 0) {
            return null;
        }
   ...
   */ getPartialRouteFromSegments(currentSegmentIndex, segmentProgress) {
   ...
   */ updateCurrentSegmentFromProgress(totalProgress) {
        ...
        this.currentSegmentIndex = Math.min(segmentIndex, this.routeSegments.length - 1);
   ...
   */ goToCheckpoint(checkpointIndex) {
        if (!this.timeline || checkpointIndex < 0 || checkpointIndex >= this.checkpoints.length) {
            return;
        }
   ...
   */ goToNextCheckpoint() {
        const nextIndex = Math.min(this.currentSegmentIndex + 1, this.checkpoints.length - 1);
   ...
   */ animateToNextCheckpoint() {
        ...
        const segmentTween = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to(this.segmentProgressRef, {
            value: 1,
            duration: segmentDuration,
            ease: this.config.ease
        });
        ...
        const tween = this.timeline.tweenFromTo(fromLabel, toLabel, {
            ...
            onComplete: ()=>{
                ...
                this.segmentProgressRef.value = 1;
                this.callbacks.onCheckpointReached?.(nextCheckpointIndex, this.checkpoints[nextCheckpointIndex]);
                this.callbacks.onSegmentComplete?.(currentSegmentIndex, nextCheckpointIndex);
            }
        });
    }
    /**
   * Anima do checkpoint A até o checkpoint B (método genérico)
   */ animateFromCheckpointToCheckpoint(fromIndex, toIndex) {
        if (!this.timeline) return;
        ...
        this.timeline.tweenFromTo(fromLabel, toLabel, {
            ...
            onComplete: ()=>{
                ...
                this.segmentProgressRef.value = 1;
                this.callbacks.onCheckpointReached?.(toIndex, this.checkpoints[toIndex]);
...
function MapView({ locations, selectedLocationId, onLocationSelect }) {
    ...
    const sortedLocations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return [
            ...locations
        ].sort((a, b)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchRoute = async ()=>{
            try {
                const coordinates = sortedLocations.map((loc)=>`${loc.lng},${loc.lat}`).join(";");
                ...
                if (data.code === "Ok" && data.routes && data.routes.length > 0) {
                    ...
                    const checkpoints = sortedLocations.map((loc)=>({
                            id: loc.id,
                            name: loc.name,
                            lat: loc.lat,
                            lng: loc.lng
                        ...
                        animationControllerRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$lib$2f$route$2d$animation$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RouteAnimationController"]({
                            ...
                            callbacks: {
                                ...
                                onSegmentStart: (fromIndex, toIndex)=>{
                                    console.log(`Iniciando segmento: ${checkpoints[fromIndex].name} → ${checkpoints[toIndex].name}`);
                                }
                            }
                        });
                    }
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Configure VITE_MAPBOX_TOKEN no arquivo .env"
                    }, void 0, false, {
                        fileName: "[project]/client/src/components/map-view.tsx",
                        lineNumber: 308,
                        columnNumber: 11
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            routeData && sortedLocations.length >= 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    className: "h-9 w-9",
                                    disabled: !animationControllerRef.current?.hasPreviousCheckpoint(),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$skip$2d$back$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__SkipBack$3e$__["SkipBack"], {
                                        className: "w-4 h-4"
                                    }, void 0, false, {
                                        fileName: "[project]/client/src/components/map-view.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    className: "h-10 w-10",
                                    children: isPreviewMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$pause$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Pause$3e$__["Pause"], {
                                        className: "w-5 h-5"
                                    }, void 0, false, {
                                        fileName: "[project]/client/src/components/map-view.tsx",
                                        lineNumber: 533,
...
//# sourceMappingURL=_1b849cbb._.js.map